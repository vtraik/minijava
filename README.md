...
```
- Σημείωση: Η printOffsets (src/Main.java) καλείται με όρισμα 1 για να τυπώνει και τους τύπους των παραμέτρων. Μπορείται να
βάλετε 0 για να τυπώνει σαν τα παραδείγματα.
