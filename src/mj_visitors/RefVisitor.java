...
class RefVisitor extends GJDepthFirst<String, String> {
  ...
  private String findVarType(Identifier n, String id, String scope) throws Exception {
    ...
    return null;
    else return findVarType(n, id, superClass.getName() + "|null");
  }

  private String findMethodRetType(MessageSend n, ClassInfo classI, String name, String[] args)
      throws Exception {
  ...
  public String visit(MethodDeclaration n, String argu) throws Exception {
    ...
    if (!subtype(symbt, expRetType, methRetType))
      throw new Exception(
          String.format(
              "Return type mismatch in %s.%s at %s:%s -> expected <%s>, got <%s>",
              className,
              method.getRetId().getName(),
              getToken(n.f10).beginLine,
              getToken(n.f10).beginColumn,
              methRetType,
              expRetType));
  ...
  public String visit(AssignmentStatement n, String argu) throws Exception {
    ...
    if (!subtype(symbt, expr, id)) {
      throw new Exception(
          String.format(
              "Assignment type mismatch at %s:%s -> lval:%s, rval:%s",
  ...
  public String visit(IfStatement n, String argu) throws Exception {
    ...
    if (!exprType.equals("boolean"))
      throw new Exception(
          String.format(
              "Condition in if statement must be of type boolean at %s:%s",
              getToken(n.f2).beginLine, getToken(n.f2).beginColumn));
  ...
  public String visit(WhileStatement n, String argu) throws Exception {
    ...
    if (!exprType.equals("boolean"))
      throw new Exception(
          String.format(
              "Condition in while statement must be of type boolean at %s:%s",
              getToken(n.f2).beginLine, getToken(n.f2).beginColumn));
  ...
  public String visit(PrintStatement n, String argu) throws Exception {
    ...
    if (!type.equals("int"))
      throw new Exception(
          String.format(
              "Print's argument should be of type int at %s:%s",
              getToken(n.f2).beginLine, getToken(n.f2).beginColumn));
    return null;
  }
  ...
  public String visit(AndExpression n, String argu) throws Exception {
    ...
    if (!type1.equals("boolean"))
      throw new Exception(
          String.format(
              "Invalid type in (&&) expression at %s:%s -> %s",
  ...
  public String visit(ArrayLookup n, String argu) throws Exception {
    ...
    if (!type1.equals("int[]"))
      throw new Exception(
          String.format(
              "Invalid type in array lookup expression at %s:%s -> %s",
              getToken(n.f0).beginLine, getToken(n.f0).beginColumn, type1));
    if (!type2.equals("int"))
      throw new Exception(
          String.format(
              "Invalid type in array index at %s:%s -> %s",
              getToken(n.f2).beginLine, getToken(n.f2).beginColumn, type2));
  ...
  public String visit(ArrayLength n, String argu) throws Exception {
    ...
    if (!type1.equals("int[]"))
      throw new Exception(
          String.format(
              ".length is not supported for type %s at %s:%s",
              type1, getToken(n.f0).beginLine, getToken(n.f0).beginColumn));
  ...
  public String visit(MessageSend n, String argu) throws Exception {
    ...
    if (classI == null) {
      throw new Exception(
          String.format(
              "Method call on invalid type %s at %s:%s",
    ...
    if (retType == null) {
      ...
      throw new Exception(
          String.format(
              "No compatible method found at %s:%s -> %s.%s(%s)",
  ...
  public String visit(Identifier n, String argu) throws Exception {
    String ret;
    if ((ret = findVarType(n, n.f0.tokenImage, argu)) != null) return ret;
    ...
    if (methN.equals("null"))
      throw new Exception(
          String.format(
              "Undefined identifier %s in %s at %s:%s",
              n.f0.tokenImage, classN, getToken(n.f0).beginLine, getToken(n.f0).beginColumn));
    else
      throw new Exception(
          String.format(
              "Undefined identifier %s in %s.%s at %s:%s",
              n.f0.tokenImage,
              classN,
              methN,
              getToken(n.f0).beginLine,
              getToken(n.f0).beginColumn));
  }
  ...
  public String visit(Type n, String argu) throws Exception {
    ...
    if (n.f0.which == 3) return ((Identifier) n.f0.choice).f0.tokenImage;
    else return super.visit(n, argu);
  }
  ...
  public String visit(AllocationExpression n, String argu) throws Exception {
    ...
    if (classI == null)
      throw new Exception(
          String.format(
              "Class %s isn't defined at %s:%s",
              className, getToken(n.f1).beginLine, getToken(n.f1).beginColumn));
  ...
  public String visit(NotExpression n, String argu) throws Exception {
    ...
    if (!type.equals("boolean"))
      throw new Exception(
          String.format(
              "Invalid not expression type at %s:%s -> %s",
